...
> = {
  주일설교: {
    label: '주일 메인 설교',
    description: '주일 본예배 말씀을 다시 확인할 수 있습니다.',
    accent: '#8B5E34',
    background: '#F5EBDD',
  },
  오후예배설교: {
    label: '오후예배 설교',
    description: '주일 오후에 이어지는 말씀을 모아두었습니다.',
    accent: '#7A694D',
    background: '#EFE6D8',
  },
  새벽기도설교: {
    label: '새벽기도 설교',
    description: '하루를 시작하며 듣는 새벽 말씀입니다.',
    accent: '#A16207',
    background: '#FEF3C7',
  },
};
  ...
  return (
    <>
      ...
      <main className="flex-1 pt-16">
        <PageHero
          eyebrow="Sermons"
          title="최근 설교를 카테고리별로 빠르게 다시 볼 수 있습니다"
          description="주일설교, 오후예배 설교, 새벽기도 설교를 각 1개씩만 정리해 복잡하지 않게 구성했습니다."
