...
export default function NewFamilyPage() {
  ...
  return (
    <main className="flex-1">
      <PageHero
        eyebrow="New Family"
        title="새가족 등록은 절차를 먼저 확인하고 신청하도록 구성했습니다"
        description="헤더의 새가족등록 메뉴를 누르면 바로 신청서를 보여주지 않고, 먼저 등록 절차와 안내를 확인한 뒤 등록하기 버튼으로 신청 페이지에 들어가도록 흐름을 나눴습니다."
        ...
        <div className="flex flex-wrap justify-center gap-2">
          {flowSteps.map(item => (
            <span
              ...
              style={{ backgroundColor: 'rgba(255,255,255,0.82)', color: '#8B5E34' }}
            >
              {item.step}
            </span>
          ))}
          ...
          <div className="space-y-6">
            <div className="rounded-[2rem] border bg-white p-6 md:p-8" style={{ borderColor: '#EEE4D7' }}>
              ...
              <p className="mt-3 text-sm leading-7" style={{ color: '#5F6570' }}>
                새가족등록은 절차 안내를 먼저 확인한 뒤, 실제 신청 페이지에서 인적사항을 입력하는 방식입니다.
                한 화면에 모든 내용을 몰아넣지 않고 단계별로 나누어 처음 보는 분들도 부담 없이 진행할 수 있게 구성했습니다.
              </p>
