...
export default function ChurchGuideContent() {
  ...
  return (
    <AboutPageFrame
      ...
      description="처음 방문하는 분들도 편안하게 이해할 수 있도록 교회 소개와 인사말, 핵심 가치, 첫 방문 안내를 한 화면에 담았습니다."
    ...
    >
      ...
      <section className="mx-auto max-w-6xl px-4 pb-18 pt-18 md:pb-20 md:pt-20">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {firstVisitPoints.map(point => (
            ...
            >
              ...
              <h3 className="mt-4 text-lg font-bold" style={{ color: '#1E1B4B' }}>
                {point.title}
              </h3>
